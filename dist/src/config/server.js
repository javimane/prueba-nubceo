...
class Server {
    constructor() {
        ...
        this.swaggerJsDoc = require('swagger-jsdoc');
    ...
    routes() {
        this.app.use('/api-doc', this.swaggerUI.serve, this.swaggerUI.setup(this.swaggerJsDoc(swagger_1.swaggerSpec)));
        this.app.use('/api/users', userRoutes_1.default);
        this.app.use('/api/movies', movieRoutes_1.default);
        this.app.use('/api/tvshows', tvShowRoutes_1.default);
        this.app.use('/api/directors', directorRoutes_1.default);
    }
    listen() {
